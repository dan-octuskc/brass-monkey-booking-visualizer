...
## App scripts
- `visualizer4.py` — Streamlit dashboard
...
streamlit run visualizer4.py --server.runOnSave true
```

## Streamlit Community Cloud
1. Push this repo to GitHub.
2. Go to https://share.streamlit.io, connect GitHub, select your repo, script path `visualizer4.py`.
